<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="RequerimientoCliente.aspx.cs" Inherits="ETNA.SGI.WebSite.PaginasWeb.RequerimientoCliente" %>
...
"Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
    ...
    Calendar.prototype.cal_header = function () {
        ...
        vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Lu</B></FONT></TD>";
        ...
        vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Ju</B></FONT></TD>";
        vCode = vCode + "<TD WIDTH='14%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Vi</B></FONT></TD>";
        vCode = vCode + "<TD WIDTH='16%'><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Sá</B></FONT></TD>";
        vCode = vCode + "</TR>";
        ...
        <tr>
            <td colspan="3" style="text-align: center; font-weight: normal; font-style: normal; font-family: Verdana; font-variant: normal;">
                <asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="Small" ForeColor="DarkSlateBlue"
                    ...
                    Text="Lista de Requerimientos"></asp:Label></td>
        </tr>
        <tr>
            <td colspan="3">
                <asp:TextBox ID="txtfecha" runat="server" AutoPostBack="True" 
                    Font-Names="Verdana" Font-Size="Small" Width="70px"></asp:TextBox>
                <a href="javascript:show_calendar('form1.txtfecha');" 
                    onmouseout="window.status=''; nd(); return true;" 
                    onmouseover="window.status='Elige fecha'; overlib('Pulsa para elegir fecha del mes actual en el calendario emergente.'); return true;">
                <img id="IMG1" border="0" language="javascript" src="../Imagenes/calendar.gif" 
                    style="width: 16px; height: 15px" /> </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
        ...
        <tr>
            <td colspan="3">
                <asp:ImageButton ID="btnGenerarReq" runat="server" 
                    ...
                    ToolTip="Ingresar Nuevo Requerimiento" 
                    DescriptionUrl="~/PaginasWeb/WebRequirimientoNEW.aspx" 
                    PostBackUrl="~/PaginasWeb/WebRequirimientoNEW.aspx" />
            </td>
        </tr>
    </table>
